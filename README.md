...
## 🚀 Installation
1.  Navigate to the **[Releases]([https://github.com/rameezilyasofficial/PC-Manager/releases](https://github.com/rameezilyasofficial-cloud/PC-Manager/releases/download/v1.6/PCManagerSetup.exe))** section.
